...
#SBATCH --ntasks=41
#SBATCH --time=160
#SBATCH --output=/d/hpc/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.exc-qb_04vs_14400f-40w_eager-naive-coarse.log
...
JOB_FILE_PATH="$BLENDER_PROJECT_DIRECTORY/04_very-simple_measuring_14400f-40w_eager-naive-coarse.toml"
