#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-1w_var4
#SBATCH --ntasks=2
#SBATCH --time=6000
#SBATCH --output=/d/hpc/projects/FRI/sg7710/distributed-rendering-logs/%A.sbatch.qb_04vs_14400f-1w_var4.log
...
JOB_FILE_PATH="$BLENDER_PROJECT_DIRECTORY/04_very-simple_measuring_14400f-1w_variant4.toml"
