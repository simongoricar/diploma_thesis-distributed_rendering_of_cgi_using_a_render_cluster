#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-20w_eager-naive-coarse
#SBATCH --ntasks=21
#SBATCH --time=300
#SBATCH --output=/d/hpc/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_14400f-20w_eager-naive-coarse.log
...
LOG_NAME="qb_04vs_14400f-20w_eager-naive-coarse"
BLENDER_PROJECT_DIRECTORY="$RUN_BASE_DIRECTORY/blender-projects/04_very-simple"
JOB_FILE_PATH="$BLENDER_PROJECT_DIRECTORY/04_very-simple_measuring_14400f-20w_eager-naive-coarse.toml"
