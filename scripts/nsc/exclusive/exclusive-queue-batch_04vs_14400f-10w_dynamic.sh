#!/usr/bin/env bash
#SBATCH --job-name=exc-qb_04vs_14400f-10w_dynamic
#SBATCH --ntasks=11
#SBATCH --time=600
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.exc-qb_04vs_14400f-10w_dynamic.log
...
LOG_NAME="exc-qb_04vs_14400f-10w_dynamic"
BLENDER_PROJECT_DIRECTORY="$RUN_BASE_DIRECTORY/blender-projects/04_very-simple"
JOB_FILE_PATH="$BLENDER_PROJECT_DIRECTORY/nsc-jobs/04_very-simple_measuring_14400f-10w_dynamic.toml"
