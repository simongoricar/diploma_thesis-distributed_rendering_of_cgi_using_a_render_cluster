#!/usr/bin/env bash
#SBATCH --job-name=exc-qb_04vs_14400f-40w_naive-fine
#SBATCH --ntasks=41
#SBATCH --time=160
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.exc-qb_04vs_14400f-40w_naive-fine.log
...
LOG_NAME="exc-qb_04vs_14400f-40w_naive-fine"
