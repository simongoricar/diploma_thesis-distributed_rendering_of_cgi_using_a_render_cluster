#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-10w_dynamic
#SBATCH --ntasks=11
#SBATCH --time=600
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_14400f-10w_dynamic.log
...
LOG_NAME="qb_04vs_14400f-10w_dynamic"
