#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-20w_naive-fine
#SBATCH --ntasks=21
#SBATCH --time=300
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_14400f-20w_naive-fine.log
...
LOG_NAME="qb_04vs_14400f-20w_naive-fine"
