#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-40w_eager-naive-coarse
#SBATCH --ntasks=41
#SBATCH --time=160
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_14400f-40w_eager-naive-coarse.log
...
LOG_NAME="qb_04vs_14400f-40w_eager-naive-coarse"
