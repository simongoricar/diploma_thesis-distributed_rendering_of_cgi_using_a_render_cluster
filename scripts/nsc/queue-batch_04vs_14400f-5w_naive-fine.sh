#!/usr/bin/env bash
#SBATCH --job-name=qb_04vs_14400f-5w_naive-fine
#SBATCH --ntasks=6
#SBATCH --time=1020
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_14400f-5w_naive-fine.log
...
LOG_NAME="qb_04vs_14400f-5w_naive-fine"
