...
#SBATCH --ntasks=2
#SBATCH --time=30
#SBATCH --output=/ceph/grid/home/sg7710/diploma/distributed-rendering-diploma/logs/%A.sbatch.qb_04vs_demo_60f-1w_naive-fine.log
...
JOB_FILE_PATH="$BLENDER_PROJECT_DIRECTORY/nsc-jobs/04_very-simple_demo_60f-1w.toml"
